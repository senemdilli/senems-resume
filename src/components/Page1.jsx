...
const Page1 = () => {
    const componentsData = [
        ...
        {emoji: '🎓', firm: 'Duzce Kültür Fen Lisesi', title: '-', description: 'At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. ', year: 2019},
    ];
